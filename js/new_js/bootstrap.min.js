...
function(a) {
    ...
    a.fn.carousel = function(c) {
        return this.each(function() {
            ...
            typeof c == "number" ? e.to(c) : typeof c == "string" || (c = f.slide) ? e[c]() : f.interval && e.cycle()
        })
    },
...
function(a) {
    ...
    c.prototype = {
        ...
        toggle: function(b) {
            ...
            return f = c.attr("data-target"),
            f || (f = c.attr("href"), f = f && f.replace(/.*(?=#[^\s]*$)/, "")),
            e = a(f),
            e.length || (e = c.parent()),
            g = e.hasClass("open"),
            d(),
    ...
    a(function() {
        ...
        a("body").on("click.dropdown", ".dropdown form",
        function(a) {
            a.stopPropagation()
...
function(a) {
    ...
    b.prototype = {
        ...
        activate: function(b) {
            ...
            c.parent(".dropdown-menu") && (c = c.closest("li.dropdown").addClass("active")),
            c.trigger("activate")
        }
    },
...
function(a) {
    ...
    b.prototype = {
        ...
        lookup: function(b) {
            ...
            this.query ? (d = a.grep(this.source,
            function(a) {
                return c.matcher(a)
